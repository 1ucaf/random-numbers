...
const CongruentialMixedGenerator = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.mainContainer}>
      ...
      <ThemedText style={styles.subtitleContainer} type="subtitle">Generador Congruencial Multiplicativo</ThemedText>
